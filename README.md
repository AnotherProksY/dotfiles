...
```bash
brew cask install clipy tableplus telegram appcleaner discord gpg-suite docker skype microsoft-remote-desktop macvim whatsapp drawio anydesk protonvpn notion sourcetree numi
```
