...
```bash
brew install --casks tableplus telegram appcleaner discord docker boop imazing visual-studio-code maccy spotify figma obsidian chatgpt the-unarchiver httpie font-sf-mono-nerd-font-ligaturized iterm2
```
