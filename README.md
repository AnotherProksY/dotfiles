...
```bash
brew cask install clipy tableplus telegram appcleaner discord tunnelblick gpg-suite docker skype microsoft-remote-desktop fork macvim whatsapp drawio anydesk dash
```
