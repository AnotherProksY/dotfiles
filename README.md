...
```bash
brew install --casks tableplus telegram appcleaner discord docker whatsapp protonvpn boop maccy numi qlmarkdown spotify visual-studio-code notion openemu
```
