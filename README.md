...
```bash
brew cask install clipy tableplus telegram appcleaner discord spotify visual-studio-code tunnelblick gpg-suite docker skype microsoft-remote-desktop fork imazing
```
