...
```bash
brew install --casks tableplus telegram appcleaner discord docker boop clipy numi zoom firefox transmission imazing figma font-sf-mono-nerd-font visual-studio-code
```
