...
```bash
brew install --casks tableplus telegram appcleaner discord docker boop zoom firefox transmission imazing visual-studio-code outline-manager shadowsocksx-ng pycharm maccy obsidian kindavim
```
