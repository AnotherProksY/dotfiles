...
```bash
brew cask install clipy tableplus telegram appcleaner discord tunnelblick gpg-suite docker skype microsoft-remote-desktop macvim whatsapp drawio anydesk dash
```
