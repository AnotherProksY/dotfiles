...
```bash
brew install --casks tableplus telegram appcleaner discord docker boop clipy numi spotify visual-studio-code openemu zoom raspberry-pi-imager firefox transmission deepl
```
