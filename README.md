...
```bash
brew install --casks tableplus telegram appcleaner discord docker boop numi zoom firefox transmission imazing visual-studio-code outline-manager shadowsocksx-ng raycast pycharm
```
