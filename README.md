...
```bash
brew install --casks tableplus telegram appcleaner discord docker boop clipy numi spotify visual-studio-code openemu zoom firefox transmission deepl min
```
